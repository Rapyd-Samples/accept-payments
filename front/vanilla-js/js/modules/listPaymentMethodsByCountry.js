...
export default {
    ...
    sendRequest: function(form){
        ...
        let resultContainer = document.querySelector('#list_payment_methods_by_country pre');
        console.log(Object.fromEntries(formData));
        
        fetch(baseURL + 'paymentMethods?' + new URLSearchParams(Object.fromEntries(formData)), {
                method: 'GET'
            })
            .then(response => {
                if (!response.ok) {
